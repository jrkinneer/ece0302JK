    ...
    NodeType* treePtr, FunctionType visit)
{
   if (treePtr != 0) {
        // TODO
        visit(treePtr->item);
        NodeType* leftNode = treePtr->leftChildPtr;
        preorder(leftNode, visit);

        NodeType* rightNode = treePtr->rightChildPtr;
        preorder(rightNode, visit);
   }
};
    ...
    NodeType* treePtr, FunctionType visit)
{
    if (treePtr != 0) {
        // TODO
        NodeType* leftNode = treePtr->leftChildPtr;
        inorder(leftNode, visit);
        visit(treePtr->item);
        NodeType* rightNode = treePtr->rightChildPtr;
        inorder(rightNode, visit);
    }
};
    ...
    NodeType* treePtr, FunctionType visit)
{
    if (treePtr != 0) {
        // TODO
        NodeType* leftNode = treePtr->leftChildPtr;
        postorder(leftNode, visit);
        NodeType* rightNode = treePtr->rightChildPtr;
        postorder(rightNode, visit);
        visit(treePtr->item);
    }
};
