...
private:
  std::size_t presentSize; //holds the overall size of the array
  int currentIndex; //holds the largest index that holds a value
  T *arr; //pointer to dynamically allocated arrays
